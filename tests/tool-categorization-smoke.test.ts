/**
 * CI-level safety net: every HanaKDE tool defined under lib/tools/ and
 * lib/memory/ must be categorized in shared/tool-categories.ts.
 *
 ...
 * the same directory.  (Source files are .ts after the JS → TS migration.)
 */
