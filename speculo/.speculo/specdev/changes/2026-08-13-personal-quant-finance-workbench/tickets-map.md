...
|---|---|---|---|---|---|---|---|---|---|---|
| T-01 | `<Path>{roots.state}/specdev/changes/{change}/ticket/01-establish-finance-plugin-shell-and-domain-contract.md</Path>` | 插件盒、总览矩阵、共享领域/来源/错误契约 | — | deep | high | yes | root | AC-001～004、032、034～037 | W1 / G0-G1 根契约 | ready |
| T-02 | `<Path>{roots.state}/specdev/changes/{change}/ticket/02-deliver-provider-capability-and-data-snapshot.md</Path>` | BYOK、多源探测/路由、可信 snapshot、本地源门 | T-01 | deep | critical | yes | root | AC-004、006、008、030、034、035、037 | W2 / G1 数据质量 | ready |
| T-03 | `<Path>{roots.state}/specdev/changes/{change}/ticket/03-deliver-asset-identity-watchlist-and-research-pool.md</Path>` | A/HK AssetRef、自选、研究池 | T-02 | deep | high | yes | root | AC-005、010 | W3 / G1 资产 | ready |
| T-04 | `<Path>{roots.state}/specdev/changes/{change}/ticket/04-deliver-quotes-kline-and-live-refresh.md</Path>` | 行情/K 线、市场时段 live、stale/选源 | T-03 | deep | critical | yes | root | AC-007、008、035 | W4 / G2 行情 | ready |
| T-05 | `<Path>{roots.state}/specdev/changes/{change}/ticket/05-deliver-financials-filings-news-and-evidence.md</Path>` | 财务/估值/公告/研报/新闻 dossier | T-04 | deep | high | yes | root | AC-009 | W5 / G2 研究底稿 | ready |
| T-06 | `<Path>{roots.state}/specdev/changes/{change}/ticket/06-deliver-local-portfolio-ledger-and-private-materials.md</Path>` | 本地账本、成本/P&L、私有资料 | T-05 | deep | critical | yes | root | AC-011～015 | W6 / G3 个人数据 | ready |
| T-07 | `<Path>{roots.state}/specdev/changes/{change}/ticket/07-deliver-screening-factors-and-strategy-definitions.md</Path>` | 声明式筛选、因子和策略版本 | T-05 | deep | high | yes | root | AC-016 | W6 / G3 量化定义 | ready |
| T-08 | `<Path>{roots.state}/specdev/changes/{change}/ticket/08-deliver-rule-aware-backtest-and-results.md</Path>` | A/HK 规则感知、来源冻结回测和结果解释 | T-07、T-06 | deep | critical | yes | root | AC-017～020、036 | W7 / G4 回测质量 | ready |
| T-09 | `<Path>{roots.state}/specdev/changes/{change}/ticket/09-deliver-monitoring-alerts-and-scheduled-research.md</Path>` | 监控选源、RunSourceManifest、任务暂停恢复 | T-08 | deep | critical | yes | root | AC-021～024、035、036 | W8 / G5 自动化 | ready |
| T-10 | `<Path>{roots.state}/specdev/changes/{change}/ticket/10-deliver-agent-research-and-consent-boundary.md</Path>` | Agent 研究、字段确认、预算和禁交易 | T-09、T-06 | deep | critical | yes | root | AC-025～029 | W9 / G6 Agent 安全 | ready |
| T-11 | `<Path>{roots.state}/specdev/changes/{change}/ticket/11-deliver-import-export-and-diagnostics.md</Path>` | 导入导出、来源清单、选源/本地同步诊断审计 | T-10、T-06 | deep | high | yes | root | AC-014、015、030、033、038 | W10 / G7 交换诊断 | ready |
| T-12 | `<Path>{roots.state}/specdev/changes/{change}/ticket/12-release-integrated-finance-workbench.md</Path>` | 全模块集成、dev loop、E2E、可卸载发布门 | T-01～T-11 | deep | critical | yes | root | AC-001～038 | W11 / G8 发布 | ready |
