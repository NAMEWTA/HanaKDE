...
- [ ] AC-002、AC-003、AC-004、AC-009、AC-012：编辑、预览、主题、媒体占位、Page/Widget 共享状态通过。
- [ ] 验证矩阵写入 `<Path>{roots.state}/specdev/changes/2026-08-13-markdown-wechat-plugin/evidence/T-02.md</Path>`。
- [ ] 代码、资产和测试未超出 `<Path>plugins/markdown-wechat/**</Path>`。
