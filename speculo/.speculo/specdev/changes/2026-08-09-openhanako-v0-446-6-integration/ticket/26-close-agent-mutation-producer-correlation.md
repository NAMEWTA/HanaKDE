...
deviations: [D-T17-01, D-T26-01, D-T26-02]
expected_changes: ["<Path>lib/resource-io/pi-tool-operations.ts</Path>", "<Path>lib/sandbox/index.ts</Path>", "<Path>core/engine.ts</Path>", "<Path>core/session-coordinator.ts</Path>", "<Path>core/workspace-runtime/production-workspace-runtime.ts</Path>", "<Path>lib/activity-hub.ts</Path>", "<Path>server/block-extractors.ts</Path>", "<Path>server/routes/chat.ts</Path>", "<Path>desktop/src/react/stores/agent-activity-slice.ts</Path>", "<Path>tests/**</Path>"]
writable_paths: ["<Path>lib/resource-io/pi-tool-operations.ts</Path>", "<Path>lib/sandbox/index.ts</Path>", "<Path>core/engine.ts</Path>", "<Path>core/session-coordinator.ts</Path>", "<Path>core/workspace-runtime/production-workspace-runtime.ts</Path>", "<Path>lib/activity-hub.ts</Path>", "<Path>server/block-extractors.ts</Path>", "<Path>server/routes/chat.ts</Path>", "<Path>desktop/src/react/stores/agent-activity-slice.ts</Path>", "<Path>tests/resource-io-sandbox-tools.test.ts</Path>", "<Path>tests/production-workspace-runtime.test.ts</Path>", "<Path>tests/activity-hub.test.ts</Path>", "<Path>tests/engine-build-tools.test.ts</Path>", "<Path>tests/session-coordinator.test.ts</Path>", "<Path>tests/block-extractors.test.ts</Path>", "<Path>tests/sessions-route.test.ts</Path>", "<Path>tests/chat-agent-activity-event.test.ts</Path>", "<Path>tests/chat-route-switching.test.ts</Path>", "<Path>tests/knowledge-workspace-e2e/fixtures/**</Path>", "<Path>tests/knowledge-workspace-e2e/specs/agent-file-changes.spec.ts</Path>"]
...
shared_paths: ["<Path>core/engine.ts</Path>", "<Path>core/session-coordinator.ts</Path>", "<Path>core/workspace-runtime/production-workspace-runtime.ts</Path>", "<Path>lib/resource-io/pi-tool-operations.ts</Path>", "<Path>lib/activity-hub.ts</Path>", "<Path>server/routes/chat.ts</Path>"]
shared_path_owners: ["<Path>core/engine.ts</Path> => T-26 / Root Lead", "<Path>core/session-coordinator.ts</Path> => T-26 / Root Lead", "<Path>core/workspace-runtime/production-workspace-runtime.ts</Path> => T-26 / Root Lead", "<Path>lib/resource-io/pi-tool-operations.ts</Path> => T-26 / Root Lead", "<Path>lib/activity-hub.ts</Path> => T-26 / Root Lead", "<Path>server/routes/chat.ts</Path> => T-26 / Root Lead"]
---
...
- **共享路径：** `core/engine.ts`、desktop session factory、production runtime、Pi-tool adapter与ActivityHub由 T-26/Root Lead串行拥有。
- **D-T26-01：** 真实 desktop E2E 证明 tool result 未携带任何 details。根因是 desktop `SessionCoordinator` 已创建并持有 `sessionPathRef`，但其 `buildTools` 调用没有注入该身份，令 write/edit 的 `getSessionPath()` 恒为 `null` 并按既有 fail-closed 规则跳过 SessionFile/correlation。Root Lead 批准仅修改 `<Path>core/session-coordinator.ts</Path>` 与 `<Path>tests/session-coordinator.test.ts</Path>`，把该已存在的 session path callback传入当前 desktop工具组装；不得改变后台/bridge session identity、SessionRef公共契约、History API或持久化模型。
- **D-T26-02：** 修正 D-T26-01 后，真实 desktop E2E 已通过持久 strict fact，但 page reload 的历史请求早于 WS session subscription，导致现有 `ActivityHub.rebroadcastSession` 事件被 scope filter 丢弃。Root Lead 批准仅修改 `<Path>server/routes/chat.ts</Path>` 与 `<Path>tests/chat-route-switching.test.ts</Path>`：在授权客户端首次新增该 session subscription 后调用一次既有内存重播；重复消息不得重播，不新增 route/message/store、持久 correlation 或 History权限。
