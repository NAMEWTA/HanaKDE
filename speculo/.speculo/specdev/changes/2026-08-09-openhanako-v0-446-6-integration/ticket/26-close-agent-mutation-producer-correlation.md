...
shared_paths: ["<Path>core/engine.ts</Path>", "<Path>core/session-coordinator.ts</Path>", "<Path>core/workspace-runtime/production-workspace-runtime.ts</Path>", "<Path>lib/resource-io/pi-tool-operations.ts</Path>", "<Path>lib/activity-hub.ts</Path>"]
shared_path_owners: ["<Path>core/engine.ts</Path> => T-26 / Root Lead", "<Path>core/session-coordinator.ts</Path> => T-26 / Root Lead", "<Path>core/workspace-runtime/production-workspace-runtime.ts</Path> => T-26 / Root Lead", "<Path>lib/resource-io/pi-tool-operations.ts</Path> => T-26 / Root Lead", "<Path>lib/activity-hub.ts</Path> => T-26 / Root Lead"]
---
