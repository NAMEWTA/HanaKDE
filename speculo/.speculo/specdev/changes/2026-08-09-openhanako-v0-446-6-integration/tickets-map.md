...
| T-20 | `<Path>{roots.state}/specdev/changes/{change}/ticket/20-upgrade-office-to-knowledge-ingestion.md</Path>` | Office 经共享 Extraction 进入 IR/index/Search 并按版本重建 | T-14, T-15, T-19 | deep | critical | yes | Worker-T-20 / Lead E2E | AC-003, AC-017, AC-021, AC-022 | W6 | in_progress |
