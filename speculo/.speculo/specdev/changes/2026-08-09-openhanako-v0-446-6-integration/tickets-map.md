...
| T-11 | `<Path>{roots.state}/specdev/changes/{change}/ticket/11-establish-main-workspace-infrastructure.md</Path>` | 唯一 main lifecycle、watcher、baseline 与四态 health | T-10 | deep | critical | yes | Worker-T-11 / Lead集成 | AC-004, AC-005, AC-009, AC-012—AC-014, AC-025, AC-026 | W3 | review |
