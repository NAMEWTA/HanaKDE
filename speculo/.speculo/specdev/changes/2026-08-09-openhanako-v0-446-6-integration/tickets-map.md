...
| T-09 | `<Path>{roots.state}/specdev/changes/{change}/ticket/09-integrate-v0-446-6.md</Path>` | 冻结 target ancestry 与完整上游功能基线 | T-08 | deep | critical | yes | Worker-T-09 / Lead集成 | AC-001—AC-003 | W1.8/G1 | review |
