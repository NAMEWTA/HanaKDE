...
| T-03 | `<Path>{roots.state}/specdev/changes/{change}/ticket/03-integrate-v0-433-1.md</Path>` | `v0.433.1` 可审计 checkpoint | T-02 | deep | high | yes | Worker-T-03 / Lead集成 | AC-001—AC-003 | W1.2/G1 | in_progress |
