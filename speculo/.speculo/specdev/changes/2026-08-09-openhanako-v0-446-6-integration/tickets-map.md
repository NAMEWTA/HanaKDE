...
| T-13 | `<Path>{roots.state}/specdev/changes/{change}/ticket/13-deliver-main-only-file-history.md</Path>` | main-only capture/deleted/timeline/diff/retention/quota (correction round 1; `e4600aff` Lead accepted) | T-10, T-11 | deep | critical | yes | Worker-T-13-Correction / Lead集成 | AC-005—AC-007, AC-025, AC-026 | W4 | done |
| T-14 | `<Path>{roots.state}/specdev/changes/{change}/ticket/14-converge-knowledge-events-and-repair.md</Path>` | Knowledge 只消费统一事件/shared baseline 并 scoped repair | T-10, T-11 | deep | critical | yes | Worker-T-14 / Lead集成 | AC-003, AC-011—AC-013, AC-017 | W4 | done |
...
- production assembly/cutover 的唯一 owner 是 T-12；D-T12-06 额外授予 T-12 真实已激活 `file-history-sqlite` 的 registry/scanner/receipt 最小修订，且不触及 `lib/file-history/**`；Resource Kernel 是 T-10；Workspace infrastructure 是 T-11；History domain 是 T-13；Knowledge event/repair 是 T-14；Extraction core 是 T-19。
