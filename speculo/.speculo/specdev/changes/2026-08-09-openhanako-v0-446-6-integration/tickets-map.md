...
| T-02 | `<Path>{roots.state}/specdev/changes/{change}/ticket/02-integrate-v0-421-24.md</Path>` | `v0.421.24` 可审计 checkpoint | T-01 | deep | high | yes | Worker-T-02 / Lead集成 | AC-001—AC-003 | W1.1/G1 | in_progress |
