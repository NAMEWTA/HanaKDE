...
| T-07 | `<Path>{roots.state}/specdev/changes/{change}/ticket/07-integrate-v0-443-46.md</Path>` | `v0.443.46` checkpoint 与 History/Extraction 输入 | T-06 | deep | critical | yes | Worker-T-07 / Lead集成 | AC-001—AC-003 | W1.6/G1 | review |
