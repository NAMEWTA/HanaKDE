...
| T-11 | `<Path>{roots.state}/specdev/changes/{change}/ticket/11-establish-main-workspace-infrastructure.md</Path>` | 唯一 main lifecycle、watcher、baseline 与四态 health | T-10 | deep | critical | yes | Worker-T-18 / Lead集成 | AC-004, AC-005, AC-009, AC-012—AC-014, AC-025, AC-026 | W3 | in_progress |
...
| T-19 | `<Path>{roots.state}/specdev/changes/{change}/ticket/19-deliver-shared-document-extraction.md</Path>` | 共享多格式 Extraction、Materialize 与稳定失败 | T-10 | deep | critical | yes | Worker-T-19 / Lead集成 | AC-018—AC-020, AC-022, AC-023, AC-026 | W3 | in_progress |
