...
| T-13 | `<Path>{roots.state}/specdev/changes/{change}/ticket/13-deliver-main-only-file-history.md</Path>` | main-only capture/deleted/timeline/diff/retention/quota (correction round 1) | T-10, T-11 | deep | critical | yes | Worker-T-13-Correction / Lead集成 | AC-005—AC-007, AC-025, AC-026 | W4 | in_progress |
