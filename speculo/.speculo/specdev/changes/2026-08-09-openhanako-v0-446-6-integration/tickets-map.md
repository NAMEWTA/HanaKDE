...
| T-05 | `<Path>{roots.state}/specdev/changes/{change}/ticket/05-integrate-v0-441-32.md</Path>` | `v0.441.32` checkpoint 与重复职责输入清单 | T-04 | deep | high | yes | Worker-T-05 / Lead集成 | AC-001—AC-003 | W1.4/G1 | in_progress |
