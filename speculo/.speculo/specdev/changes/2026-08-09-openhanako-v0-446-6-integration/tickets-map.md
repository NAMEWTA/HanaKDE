...
| T-21 | `<Path>{roots.state}/specdev/changes/{change}/ticket/21-converge-production-native-packaging.md</Path>` | clean install/build 与双平台 native/package inputs 就绪 | T-12, T-16, T-17, T-18, T-20 | deep | critical | yes | Worker-T-21 shared owner / Lead Gate | AC-002, AC-003, AC-018—AC-023, AC-027 | G8 | in_progress |
