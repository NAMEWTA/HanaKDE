...
| T-08 | `<Path>{roots.state}/specdev/changes/{change}/ticket/08-integrate-v0-443-54-through-v0-444-1.md</Path>` | `v0.443.54`/`v0.444.1` 两个子 checkpoint | T-07 | deep | high | yes | Worker-T-08 / Lead集成 | AC-001—AC-003 | W1.7/G1 | review |
