...
| T-18 | `<Path>{roots.state}/specdev/changes/{change}/ticket/18-fuse-at-search-lifecycle.md</Path>` | `@` query/loading/cancel/stale-response lifecycle 正确 | T-09 | standard | medium | yes | Worker-T-18 / Lead E2E | AC-024 | W3 | review |
