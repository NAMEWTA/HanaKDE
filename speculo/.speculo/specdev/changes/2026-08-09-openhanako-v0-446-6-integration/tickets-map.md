...
| T-10 | `<Path>{roots.state}/specdev/changes/{change}/ticket/10-converge-resource-kernel.md</Path>` | 唯一 Resource Kernel、Materialize/Transfer/Root/Event contracts | T-09 | deep | critical | yes | Worker-T-10 / Lead Gate | AC-011, AC-014, AC-020, AC-023, AC-026 | G2 | in_progress |
