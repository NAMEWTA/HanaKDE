...
G9_MAC_STATUS ticket=T-23 state=review checkpoint=2b0ef66b result=final-arm64-package-dmg-seed-inventory-packaged-office-history-community-todo-runtime-production-workspace-single-owner-loss-reconcile-cross-platform-spec-guard-type-first-bus-adapter-pass residual=macos-x64-runtime-dmg,literal-kernel-descriptor-accounting,physical-hardware-sleep-event-loss-reconcile next=T-22/T-25-rerun
...
G10_FINAL_REFRESH ticket=T-25 state=blocked product=feb906d6 quality=8aa9f7b1 verdict=BLOCKED covered=Agent-producer,Workspace-History,local-quality residual=T-22-windows-runtime,T-23-macos-x64-descriptor-physical-sleep,exact-SHA-platform-packages next=run-owning-platform-gates-then-rerun-T25
