...
DELIVERY ticket=T-23 state=integrated workspace=specdev-worktree/T-23 checkpoint=dce4676b evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-23.md</Path> residual=macos-x64-runtime-dmg-and-hardware-sleep-resume-interactive-E2E-and-post-change-packaged-launch
G9_MAC_STATUS ticket=T-23 state=review checkpoint=dce4676b result=arm64-macos-harness-dmg-seed-inventory-pass-atomic-event-proof-cross-platform-spec-guard-type-first-bus-adapter-regression-pass residual=macos-x64-runtime-dmg-hardware-sleep-resume-interactive-E2E-post-change-packaged-launch next=T-22/T-24
