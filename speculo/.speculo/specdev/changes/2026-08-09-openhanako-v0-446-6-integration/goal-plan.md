...
DELIVERY ticket=T-23 state=integrated workspace=specdev-worktree/T-23 checkpoint=dce4676b evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-23.md</Path> residual=macos-x64-runtime-dmg,descriptor-accounting,hardware-sleep-event-loss-reconcile,production-signing-notarization
G9_MAC_STATUS ticket=T-23 state=review checkpoint=2421bfed result=final-arm64-package-dmg-seed-inventory-packaged-office-history-and-community-todo-runtime-atomic-event-proof-cross-platform-spec-guard-type-first-bus-adapter-pass residual=macos-x64-runtime-dmg,descriptor-accounting,hardware-sleep-event-loss-reconcile,production-signing-notarization next=T-22/T-25-rerun
