...
DECISION id=D-W4-01 owner=Lead scope=T-12,T-14 contract=Knowledge-lastCompleteSequence-afterSequence-and-shared-baseline-difference-cursor-use-ResourceEventBus.sequence-only;WorkspaceObservation.cursor-is-physical-owner-private-and-must-never-be-persisted-or-compared-by-Knowledge;adapter-reads-latest-ResourceEventBus-sequence-at-root-revalidated-stable-baseline-or-diff-point;later-bus-events-replay-after-that-cursor proof=baseline-inflight-later-event-and-deliberately-unequal-workspace-vs-bus-cursor-regressions merge=prohibited-until-both-production-seams-pass
```
