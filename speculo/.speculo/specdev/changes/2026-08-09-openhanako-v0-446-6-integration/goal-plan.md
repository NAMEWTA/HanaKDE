...
DELIVERY ticket=T-23 state=integrated workspace=specdev-worktree/T-23 checkpoint=dce4676b evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-23.md</Path> residual=macos-x64-runtime-dmg-and-hardware-sleep-resume-interactive-E2E
G9_MAC_STATUS ticket=T-23 state=review checkpoint=dce4676b result=arm64-macos-harness-dmg-seed-inventory-pass-packaged-community-todo-runtime-pass-atomic-event-proof-cross-platform-spec-guard-type-first-bus-adapter-regression-pass residual=macos-x64-runtime-dmg-hardware-sleep-resume-interactive-E2E next=T-22/T-24
...
DELIVERY ticket=T-25 state=blocked workspace=specdev-worktree/T-25 checkpoint=dce4676b evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-25.md</Path> residual=T-22-windows-runtime-and-T-23-review
G10_FINAL ticket=T-25 state=blocked checkpoint=dce4676b verdict=BLOCKED next=T-22/T-23 re-run-T-25
