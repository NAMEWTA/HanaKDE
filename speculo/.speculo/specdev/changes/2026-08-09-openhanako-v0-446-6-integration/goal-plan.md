...
DELIVERY ticket=T-23 state=in_progress workspace=specdev-worktree/T-23 checkpoint=fa569c0c evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-23.md</Path> residual=macos-x64-and-hardware-sleep-resume
