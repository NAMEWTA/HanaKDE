...
DELIVERY ticket=T-23 state=integrated workspace=specdev-worktree/T-23 checkpoint=99b6a993 evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-23.md</Path> residual=macos-x64-runtime-dmg,literal-kernel-descriptor-accounting,physical-hardware-sleep-event-loss-reconcile
G9_MAC_STATUS ticket=T-23 state=review checkpoint=99b6a993 product=feb906d6 quality=8aa9f7b1 result=exact-current-arm64-package-dmg-seed-inventory-packaged-office-workbench-history-agent-history-at-search-community-todo-runtime-production-workspace-single-owner-loss-reconcile-cross-platform-spec-guard-type-first-bus-adapter-pass residual=macos-x64-runtime-dmg,literal-kernel-descriptor-accounting,physical-hardware-sleep-event-loss-reconcile next=T-22/T-25-rerun
