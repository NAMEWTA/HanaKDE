...
CORRECTION ticket=T-12 round=2/3 checkpoint=e758c7a12d31e8385b4993c406ae5acc04b18635 workspace=specdev-worktree/T-12 failure=main-normal-workspace-change-must-bridge-only-one-ResourceEventBus-fact-no-coverage-resources-duplicate;repair-reasons-sequence-gap-catch-up-stale-event-hint-invalid-or-unresolvable-must-run-fresh-canonical-reportGap-or-retry-baseline-not-cache-replay;shared-source-cursor-must-equal-stable-ResourceEventBus.latestSequence-without-max-or-fabrication;directory-create-modify-delete-must-trigger-source-repair-or-equivalent-complete-descendant-reconciliation preserve=all-round-1-invariants merge=prohibited-until-real-port-and-four-new-regressions-pass
```
