...
DELIVERY ticket=T-23 state=integrated workspace=specdev-worktree/T-23 checkpoint=dce4676b evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-23.md</Path> residual=current-final-sha-package,macos-x64-runtime-dmg,descriptor-accounting,hardware-sleep-event-loss-reconcile,packaged-office-history-direct-flow
G9_MAC_STATUS ticket=T-23 state=review checkpoint=dce4676b result=arm64-macos-harness-historical-dmg-seed-inventory-packaged-community-todo-runtime-atomic-event-proof-cross-platform-spec-guard-type-first-bus-adapter-and-current-dev-office-E2E-pass residual=current-final-sha-package,macos-x64-runtime-dmg,descriptor-accounting,hardware-sleep-event-loss-reconcile,packaged-office-history-direct-flow next=T-22/T-25-rerun
