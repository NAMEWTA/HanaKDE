...
DELIVERY ticket=T-17 state=review workspace=specdev-worktree/T-17 checkpoint=2e79c692 evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-17.md</Path> residual=producer-session-operation-resource-envelope-and-owner-E2E
