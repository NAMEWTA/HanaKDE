...
DELIVERY ticket=T-25 state=blocked workspace=specdev-worktree/T-25 checkpoint=2421bfed evidence=<Path>{roots.state}/specdev/changes/{change}/evidence/T-25.md</Path> residual=T-22-windows-runtime,T-23-review,T-17-producer-envelope
G10_FINAL ticket=T-25 state=blocked checkpoint=2421bfed verdict=BLOCKED next=T-22/T-23/T-17 re-run-T-25
