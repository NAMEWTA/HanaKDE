...
id: T-22
title: "交付关闭、Workspace 切换与悬空文档"
status: done
planning_depth: standard
planning_depth_reason: "历史完成 Ticket 的 SpecDev v3 兼容迁移；保留既有实现、验证与验收记录。"
ready: false
risk: medium
blocked_by: ["T-05","T-18","T-19","T-20","T-21"]
contract_ids: ["KW-US-045","KW-US-046","KW-US-047","KW-US-048","KW-US-050","KW-US-051","KW-US-052","KW-US-136","KW-US-137","KW-US-138","KW-US-139","KW-US-140","KW-US-141","KW-US-142"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/22-deliver-close-switch-orphan-flow.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
