...
ready: false
risk: medium
blocked_by: ["T-04","T-06","T-19"]
contract_ids: ["KW-US-133","KW-US-134","KW-US-135"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/21-deliver-external-change-conflicts.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
