...
id: T-20
title: "交付编辑组、标签、临时预览与面包屑"
status: done
planning_depth: standard
planning_depth_reason: "历史完成 Ticket 的 SpecDev v3 兼容迁移；保留既有实现、验证与验收记录。"
ready: false
risk: medium
blocked_by: ["T-15","T-18"]
contract_ids: ["KW-US-035","KW-US-036","KW-US-037","KW-US-038","KW-US-039","KW-US-040","KW-US-049","KW-US-053","KW-US-054"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/20-deliver-groups-tabs-breadcrumbs.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
