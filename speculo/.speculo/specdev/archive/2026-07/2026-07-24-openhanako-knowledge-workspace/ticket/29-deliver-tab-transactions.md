...
risk: medium
blocked_by: ["T-27"]
contract_ids: ["KW-US-061","KW-US-062","KW-US-063","KW-RULE-MARKDOWN"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/29-deliver-tab-transactions.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
