...
risk: medium
blocked_by: ["T-47"]
contract_ids: ["KW-US-015","KW-US-016","KW-US-017","KW-US-018"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/48-deliver-tree-keyboard-range-selection.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
