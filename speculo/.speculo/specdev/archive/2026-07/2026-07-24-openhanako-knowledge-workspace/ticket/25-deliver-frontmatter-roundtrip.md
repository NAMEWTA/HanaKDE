...
id: T-25
title: "交付 YAML Frontmatter 保真投影"
status: done
planning_depth: standard
planning_depth_reason: "历史完成 Ticket 的 SpecDev v3 兼容迁移；保留既有实现、验证与验收记录。"
ready: false
risk: medium
blocked_by: ["T-11","T-12","T-19"]
contract_ids: ["KW-US-174","KW-RULE-MARKDOWN"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/25-deliver-frontmatter-roundtrip.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
