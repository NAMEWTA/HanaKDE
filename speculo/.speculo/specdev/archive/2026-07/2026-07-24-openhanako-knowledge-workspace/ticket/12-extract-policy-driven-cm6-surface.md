...
id: T-12
title: "抽取策略驱动的共享 CM6 表面"
status: done
planning_depth: standard
planning_depth_reason: "历史完成 Ticket 的 SpecDev v3 兼容迁移；保留既有实现、验证与验收记录。"
ready: false
risk: medium
blocked_by: ["T-01","T-02","T-11"]
contract_ids: ["KW-US-057","KW-RULE-MARKDOWN"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/12-extract-policy-driven-cm6-surface.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
