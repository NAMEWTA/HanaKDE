...
ready: false
risk: medium
blocked_by: ["T-08","T-12","T-17"]
contract_ids: ["KW-US-041","KW-US-042","KW-US-043","KW-US-044","KW-US-166"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/18-establish-document-session-registry.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
