...
ready: false
risk: medium
blocked_by: ["T-10","T-23","T-27"]
contract_ids: ["KW-US-005","KW-US-006","KW-US-115","KW-US-116","KW-US-117","KW-US-118","KW-RULE-MARKDOWN","KW-RULE-COPY"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/38-deliver-attachments-cross-source-copy.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
