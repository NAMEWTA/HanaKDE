...
id: T-41
title: "交付 Markdown 页面抽取管线"
status: done
planning_depth: standard
planning_depth_reason: "历史完成 Ticket 的 SpecDev v3 兼容迁移；保留既有实现、验证与验收记录。"
ready: false
risk: medium
blocked_by: ["T-11","T-23","T-25","T-26","T-40"]
contract_ids: ["KW-RULE-INDEX"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/41-deliver-markdown-index-extraction.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
