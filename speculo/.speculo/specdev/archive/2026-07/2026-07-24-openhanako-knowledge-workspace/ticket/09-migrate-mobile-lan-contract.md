...
contract_ids: ["KW-US-010","KW-RULE-RESOURCE"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/09-migrate-mobile-lan-contract.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
