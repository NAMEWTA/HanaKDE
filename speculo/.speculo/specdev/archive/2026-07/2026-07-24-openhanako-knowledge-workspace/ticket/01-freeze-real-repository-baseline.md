...
risk: medium
blocked_by: []
contract_ids: ["KW-RULE-PREFLIGHT","KW-RULE-TEST"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/01-freeze-real-repository-baseline.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
