...
contract_ids: ["KW-US-143","KW-RULE-OBS","KW-RULE-OP","KW-RULE-RECOVERY"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/10-trace-knowledge-operation-protocol.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
