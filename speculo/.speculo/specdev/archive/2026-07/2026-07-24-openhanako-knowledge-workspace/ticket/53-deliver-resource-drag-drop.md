...
ready: false
risk: medium
blocked_by: ["T-38","T-48","T-50","T-51","T-52"]
contract_ids: ["KW-US-184","KW-US-185","KW-RULE-OP","KW-RULE-DND"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/53-deliver-resource-drag-drop.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
