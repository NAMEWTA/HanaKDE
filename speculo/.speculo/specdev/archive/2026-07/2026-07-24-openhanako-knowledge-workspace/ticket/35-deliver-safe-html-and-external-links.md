...
id: T-35
title: "交付安全 HTML、本地 URL 与外链策略"
status: done
planning_depth: standard
planning_depth_reason: "历史完成 Ticket 的 SpecDev v3 兼容迁移；保留既有实现、验证与验收记录。"
ready: false
risk: medium
blocked_by: ["T-14","T-17","T-23","T-27"]
contract_ids: ["KW-US-091","KW-US-092","KW-US-093","KW-US-094","KW-US-122","KW-RULE-MARKDOWN","KW-RULE-SEC"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/35-deliver-safe-html-and-external-links.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
