...
ready: false
risk: medium
blocked_by: ["T-24","T-33","T-35","T-37"]
contract_ids: ["KW-US-120","KW-RULE-MARKDOWN"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/39-deliver-page-section-embeds.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
