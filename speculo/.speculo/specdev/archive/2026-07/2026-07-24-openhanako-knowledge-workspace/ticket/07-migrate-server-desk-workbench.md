...
id: T-07
title: "迁移 Server、Desk 与 Workbench 兼容入口"
status: done
...
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/07-migrate-server-desk-workbench.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
