...
id: T-42
title: "交付非 Markdown 安全文本抽取"
status: done
planning_depth: standard
planning_depth_reason: "历史完成 Ticket 的 SpecDev v3 兼容迁移；保留既有实现、验证与验收记录。"
ready: false
risk: medium
blocked_by: ["T-17","T-40"]
contract_ids: ["KW-US-157","KW-RULE-INDEX"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/42-deliver-safe-text-index-extraction.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
