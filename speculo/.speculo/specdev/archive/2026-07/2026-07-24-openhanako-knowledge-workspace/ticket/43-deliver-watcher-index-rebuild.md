...
id: T-43
title: "交付 watcher 增量协调与 rebuild"
status: done
planning_depth: standard
planning_depth_reason: "历史完成 Ticket 的 SpecDev v3 兼容迁移；保留既有实现、验证与验收记录。"
ready: false
risk: medium
blocked_by: ["T-06","T-10","T-40","T-41","T-42"]
contract_ids: ["KW-US-193","KW-RULE-OBS","KW-RULE-INDEX","KW-RULE-RECOVERY"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/43-deliver-watcher-index-rebuild.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
