...
ready: false
risk: medium
blocked_by: ["T-20","T-40","T-43","T-44"]
contract_ids: ["KW-US-188","KW-US-189","KW-US-190","KW-RULE-SEARCH"]
owner: historical-implementer
expected_changes: ["<Path>{roots.state}/specdev/changes/2026-07-24-openhanako-knowledge-workspace/ticket/45-deliver-super-search.md</Path>"]
writable_paths: []
read_only_paths: []
shared_paths: []
shared_path_owners: []
