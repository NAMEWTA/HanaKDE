...
完成归档后，本包按 SpecDev 归档合同整体移动到：

```text
speculo/.speculo/specdev/archive/2026-07/2026-07-24-openhanako-knowledge-workspace/
```

现役测试通过 `tests/helpers/openhanako-knowledge-artifacts.ts` 在 active change 与归档位置之间做唯一解析；包内相对链接在整体移动后保持有效。
