...
> **拆分记录（2026-08-12）：** 本最终验收 Ticket 随 T-22/T-23 一并移入后续 change `<Path>{roots.state}/specdev/changes/2026-08-12-openhanako-v0-446-6-platform-gates/</Path>`。原 Evidence 的 `BLOCKED` verdict 仍是历史事实；后续 change 完成平台门后必须重新执行最终验收。
