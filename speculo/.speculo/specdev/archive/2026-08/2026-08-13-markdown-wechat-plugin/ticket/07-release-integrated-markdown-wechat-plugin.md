...
- [x] AC-001～AC-018 全部覆盖并记录到 `<Path>{roots.state}/specdev/changes/2026-08-13-markdown-wechat-plugin/evidence/T-07.md</Path>`。
- [x] 构建/typecheck/test/browser/removal 命令结果可复现，未用 skipped 代替通过。
- [x] 产品修改未超出 `<Path>plugins/markdown-wechat/**</Path>`；无未批准偏差。
