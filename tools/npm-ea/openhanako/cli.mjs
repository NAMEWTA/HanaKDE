#!/usr/bin/env node
// openhanako — companion distribution name for HanaKDE.
...
console.log(`
  ...
  HanaKDE — a personal AI agent with memory and soul.

  openhanako is the companion distribution name for HanaKDE; from
