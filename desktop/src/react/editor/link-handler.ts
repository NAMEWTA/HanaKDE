...
export type MarkdownLinkOpenHandler = (url: string) => void | Promise<void>;

export function createLinkClickHandler(openLink?: MarkdownLinkOpenHandler) {
...
export const linkClickHandler = createLinkClickHandler();
