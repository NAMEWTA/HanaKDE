...
export const markdownTheme = EditorView.theme({
  ...
  '.cm-knowledge-embed-content .cm-knowledge-embed-content': {
    marginBlock: 'var(--space-8)',
    backgroundColor: 'var(--overlay-subtle)',
  },
  '.cm-knowledge-embed-content:focus-visible, .cm-knowledge-embed-content a:focus-visible': {
    outline: '2px solid var(--accent)',
    outlineOffset: '2px',
  },
  ...
  '.cm-knowledge-embed-content p:first-child, .cm-knowledge-embed-content h1:first-child, .cm-knowledge-embed-content h2:first-child, .cm-knowledge-embed-content h3:first-child': {
    marginBlockStart: '0',
  },
  '.cm-knowledge-embed-content p:last-child, .cm-knowledge-embed-content ul:last-child, .cm-knowledge-embed-content ol:last-child, .cm-knowledge-embed-content pre:last-child': {
    marginBlockEnd: '0',
  },
  '.cm-knowledge-embed-status': {
    display: 'block',
    padding: 'var(--space-8) var(--space-12)',
    border: '1px solid var(--border)',
    borderRadius: 'var(--radius-sm)',
  ...
  '.cm-knowledge-embed-status.is-cycle, .cm-knowledge-embed-status.is-depth, .cm-knowledge-embed-status.is-missing, .cm-knowledge-embed-status.is-section-missing, .cm-knowledge-embed-status.is-unavailable, .cm-knowledge-embed-status.is-content-too-large, .cm-knowledge-embed-status.is-invalid-utf8': {
    color: 'var(--danger, #b54a4a)',
  },
  '.cm-markdown-cover': {
    position: 'relative',
